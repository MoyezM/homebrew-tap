...
class Gitter < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/MoyezM/gitter/releases/download/v0.0.8/gitter-v0.0.8-macos-arm64.tar.gz"
      sha256 "21840c76b3f892b8ce3193745eb6c9c93e4f95adcc8d3c5c35cc5e5ae9e25657"
    end

    # No Intel artifact exists yet. When gitter-v0.0.8-macos-x86_64.tar.gz
    # ships, uncomment and teach update-tap.sh a @SHA_X86_64@ placeholder.
    # on_intel do
    #   url "https://github.com/MoyezM/gitter/releases/download/v0.0.8/gitter-v0.0.8-macos-x86_64.tar.gz"
    #   sha256 "@SHA_X86_64@"
    # end
  end
  ...
  test do
    assert_match "0.0.8", shell_output("#{bin}/gitter -version")
  end
end
